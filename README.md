...
A XOR or Exclusive OR gate outputs a 0 if the input is the same, and 1 if the inputs are different. It acts as an **inequality detector**, or **anti-coincidence gate**. The boolean logic is
